...
Review.create("title" => "1", "starrating" => "5", "review" => "Riveting!")
Review.create("title" => "1", "starrating" => "2", "review" => "About as dull as you can get.")
Review.create("title" => "1", "starrating" => "3", "review" => "Not bad.")
Review.create("title" => "2", "starrating" => "4", "review" => "Great book, and not too many pages.")
Review.create("title" => "2", "starrating" => "4", "review" => "Excellent font and margins. Story wasn't bad, either.")
Review.create("title" => "2", "starrating" => "4", "review" => "Worth reading when there isn't a hockey game on.")
Review.create("title" => "2", "starrating" => "1", "review" => "Didn't understand it at all.")
Review.create("title" => "3", "starrating" => "2", "review" => "I thought this was about how to make gold?")
Review.create("title" => "3", "starrating" => "4", "review" => "Suspensful plot, good characters.")
Review.create("title" => "3", "starrating" => "5", "review" => "Perfect. A work of art.")
Review.create("title" => "3", "starrating" => "3", "review" => "Kind of confusing.")
